...
import com.junjunguo.phialmaps.navigator.NaviVoice;
import com.junjunguo.phialmaps.util.MyUtility;
  ...
  public static void showTtsVoiceSelectorNow(final Activity activity)
  {
    ...
    DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener()
    {
      ...
      public void onClick(DialogInterface dialog, int buttonNr)
      {
          ...
          NaviEngine.getNaviEngine().naviVoiceSpeak(activity, "Enjoy the app and have a nice day", "Enjoy the app and have a nice day", true);
      }
    };
