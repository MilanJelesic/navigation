...
public class Navigator {
    ...
    public String getArriveTime() {
        ...
        Date arrive_datetime = new Date(cur_date.getTime()+getGhResponse().getTime());
        String str_hour = String.valueOf(arrive_datetime.getHours());
        if(str_hour.length()==1){
            str_hour = "0" + str_hour;
        }
        String str_min = String.valueOf(arrive_datetime.getMinutes());
        if(str_min.length()==1){
            str_min = "0" + str_min;
        }
    ...
    public int getDirectionSign(Instruction itemData) {
        switch (itemData.getSign()) {
            ...
            case Instruction.TURN_SHARP_LEFT:
                return R.drawable.direction_turn_sharp_left;
            case Instruction.TURN_LEFT:
                return R.drawable.direction_turn_left;
            case Instruction.TURN_SLIGHT_LEFT:
                return R.drawable.direction_turn_slight_left;
            case Instruction.CONTINUE_ON_STREET:
                return R.drawable.direction_continue_straight;
            case Instruction.TURN_SLIGHT_RIGHT:
                return R.drawable.direction_turn_slight_right;
            case Instruction.TURN_RIGHT:
                return R.drawable.direction_turn_right;
            case Instruction.TURN_SHARP_RIGHT:
                return R.drawable.direction_turn_sharp_right;
